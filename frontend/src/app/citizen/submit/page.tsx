...
export default function SubmitChallenge() {
  ...
  const handleConfirmSubmit = async () => {
    ...
    for (const f of files) {
      ...
      try {
        const res = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:5000'}/api/upload`, { method: 'POST', body: formData })
          ...
          <div className="card fade-in">
            <div className="card-body">
              ...
              <div className="form-group" style={{ marginBottom: 'var(--space-3)' }}>
                ...
                <datalist id="jharkhand-districts">
                  {JHARKHAND_DISTRICTS.map(d => <option key={d} value={d} />)}
                </datalist>
              ...
              <div className="form-group" style={{ marginBottom: '2rem' }}>
                ...
                <input type="file" className="form-input" onChange={e => { const f = e.target.files?.[0]; if (f) setFiles([f]); }} />
